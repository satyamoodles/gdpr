...
/*
  Class: EdgeOxidesIconCollections
...
class EdgeOxidesIconCollections {
    ...
    private function initIconCollections() {
        $this->addIconCollection('font_awesome', new EdgeOxidesIconsFontAwesome("Font Awesome", "fa_icon"));
        $this->addIconCollection('font_elegant', new EdgeOxidesIconsFontElegant("Font Elegant", "fe_icon"));
        // $this->addIconCollection('ion_icons', new EdgeOxidesIconsIonIcons("Ion Icons", "ion_icon"));
        $this->addIconCollection('linea_icons', new EdgeOxidesIconsLineaIcons('Linea Icons', 'linea_icon'));
        $this->addIconCollection('simple_line_icons', new EdgeOxidesSimpleLineIcons('Simple Line Icons',
            'simple_line_icons'));
        // $this->addIconCollection('dripicons', new EdgeOxidesDripicons('Dripicons', 'dripicon'));
    }
...
$oxides_edgeIconCollections = EdgeOxidesIconCollections::get_instance();