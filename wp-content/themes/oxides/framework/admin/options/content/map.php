...
if ( ! function_exists('oxides_edge_content_options_map') ) {

    function oxides_edge_content_options_map() {
        ...
        $panel_content = oxides_edge_add_admin_panel(
            array(
                'page'  => '_content_page',
                'name'  => 'panel_content',
                'title' => 'General'
    ...
    add_action( 'oxides_edge_options_map', 'oxides_edge_content_options_map', 10 );
