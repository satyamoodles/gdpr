...
if ( ! function_exists('oxides_edge_fonts_options_map') ) {
	/**
	 * Font options page
	 */
	function oxides_edge_fonts_options_map() {
		 ...
		 * Headings
		 */
		$panel_headings = oxides_edge_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_headings',
				'title' => 'Headings'
		...
		//H1
		$group_heading_h1 = oxides_edge_add_admin_group(array(
		...
		$row_heading_h1_1 = oxides_edge_add_admin_row(array(
		...
		$row_heading_h1_2 = oxides_edge_add_admin_row(array(
		...
		//H2
		$group_heading_h2 = oxides_edge_add_admin_group(array(
		...
		$row_heading_h2_1 = oxides_edge_add_admin_row(array(
		...
		$row_heading_h2_2 = oxides_edge_add_admin_row(array(
		...
		//H3
		$group_heading_h3 = oxides_edge_add_admin_group(array(
		...
		$row_heading_h3_1 = oxides_edge_add_admin_row(array(
		...
		$row_heading_h3_2 = oxides_edge_add_admin_row(array(
		...
		//H4
		$group_heading_h4 = oxides_edge_add_admin_group(array(
		...
		$row_heading_h4_1 = oxides_edge_add_admin_row(array(
		...
		$row_heading_h4_2 = oxides_edge_add_admin_row(array(
		...
		//H5
		$group_heading_h5 = oxides_edge_add_admin_group(array(
		...
		$row_heading_h5_1 = oxides_edge_add_admin_row(array(
		...
		$row_heading_h5_2 = oxides_edge_add_admin_row(array(
		...
		//H6
		$group_heading_h6 = oxides_edge_add_admin_group(array(
		...
		$row_heading_h6_1 = oxides_edge_add_admin_row(array(
		...
		$row_heading_h6_2 = oxides_edge_add_admin_row(array(
		 ...
		 */
		$panel_responsive_headings = oxides_edge_add_admin_panel(
			array(
				'page' => '_fonts_page',
		...
		//H1
		$group_responsive_heading_h1 = oxides_edge_add_admin_group(array(
		...
		$row_responsive_heading_h1_1 = oxides_edge_add_admin_row(array(
		...
		//H2
		$group_responsive_heading_h2 = oxides_edge_add_admin_group(array(
		...
		$row_responsive_heading_h2_1 = oxides_edge_add_admin_row(array(
		...
		//H3
		$group_responsive_heading_h3 = oxides_edge_add_admin_group(array(
		...
		$row_responsive_heading_h3_1 = oxides_edge_add_admin_row(array(
		...
		//H4
		$group_responsive_heading_h4 = oxides_edge_add_admin_group(array(
		...
		$row_responsive_heading_h4_1 = oxides_edge_add_admin_row(array(
		...
		//H5
		$group_responsive_heading_h5 = oxides_edge_add_admin_group(array(
		...
		$row_responsive_heading_h5_1 = oxides_edge_add_admin_row(array(
		...
		//H6
		$group_responsive_heading_h6 = oxides_edge_add_admin_group(array(
		...
		$row_responsive_heading_h6_1 = oxides_edge_add_admin_row(array(
		 ...
		 */
		$panel_responsive_headings2 = oxides_edge_add_admin_panel(
			array(
				'page' => '_fonts_page',
		...
		//H1
		$group_responsive2_heading_h1 = oxides_edge_add_admin_group(array(
		...
		$row_responsive2_heading_h1_1 = oxides_edge_add_admin_row(array(
		...
		//H2
		$group_responsive2_heading_h2 = oxides_edge_add_admin_group(array(
		...
		$row_responsive2_heading_h2_1 = oxides_edge_add_admin_row(array(
		...
		//H3
		$group_responsive2_heading_h3 = oxides_edge_add_admin_group(array(
		...
		$row_responsive2_heading_h3_1 = oxides_edge_add_admin_row(array(
		...
		//H4
		$group_responsive2_heading_h4 = oxides_edge_add_admin_group(array(
		...
		$row_responsive2_heading_h4_1 = oxides_edge_add_admin_row(array(
		...
		//H5
		$group_responsive2_heading_h5 = oxides_edge_add_admin_group(array(
		...
		$row_responsive2_heading_h5_1 = oxides_edge_add_admin_row(array(
		...
		//H6
		$group_responsive2_heading_h6 = oxides_edge_add_admin_group(array(
		...
		$row_responsive2_heading_h6_1 = oxides_edge_add_admin_row(array(
		 ...
		 * Text
		 */
		$panel_text = oxides_edge_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_text',
				'title' => 'Text'
		...
		$group_text = oxides_edge_add_admin_group(array(
			'name'			=> 'group_text',
			'title'			=> 'Paragraph',
		...
		$row_text_1 = oxides_edge_add_admin_row(array(
			'name'		=> 'row_text_1',
			'parent'	=> $group_text
		));
		...
		$group_text_res1 = oxides_edge_add_admin_group(array(
		...
		$row_res_text_1 = oxides_edge_add_admin_row(array(
			'name'		=> 'row_text_1',
		...
		$group_text_res2 = oxides_edge_add_admin_group(array(
		...
		$row_res_text_2 = oxides_edge_add_admin_row(array(
			'name'		=> 'row_res_text_2',
		...
		$row_text_2 = oxides_edge_add_admin_row(array(
			'name'		=> 'row_text_2',
			'parent'	=> $group_text,
			'next'		=> true
		));
		...
		$group_link = oxides_edge_add_admin_group(array(
			'name'			=> 'group_link',
			'title'			=> 'Links',
		...
		$row_link_1 = oxides_edge_add_admin_row(array(
			'name'		=> 'row_link_1',
			'parent'	=> $group_link
		));
		...
		$row_link_2 = oxides_edge_add_admin_row(array(
			'name'		=> 'row_link_2',
			'parent'	=> $group_link,
			'next'		=> true
		));
		...
		oxides_edge_add_admin_field(array(
			...
			'options'		=> oxides_edge_get_text_decorations(),
			'parent'		=> $row_link_2
		));
	...
	add_action( 'oxides_edge_options_map', 'oxides_edge_fonts_options_map', 2 );
