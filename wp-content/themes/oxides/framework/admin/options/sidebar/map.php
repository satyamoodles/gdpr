...
if ( ! function_exists('oxides_edge_sidebar_options_map') ) {

	function oxides_edge_sidebar_options_map() {
		...
		$panel_widgets = oxides_edge_add_admin_panel(
			array(
				'page'  => '_sidebar_page',
				'name'  => 'panel_widgets',
				'title' => 'Widgets'
		...
		$group_sidebar_padding = oxides_edge_add_admin_group(array(
			'name'		=> 'group_sidebar_padding',
			'title'		=> 'Padding',
			'parent'	=> $panel_widgets
		));

		$row_sidebar_padding = oxides_edge_add_admin_row(array(
	...
	add_action( 'oxides_edge_options_map', 'oxides_edge_sidebar_options_map', 12 );
