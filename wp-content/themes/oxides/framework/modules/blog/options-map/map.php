...
if ( ! function_exists('oxides_edge_blog_options_map') ) {

	function oxides_edge_blog_options_map() {
		...
		$panel_blog_lists = oxides_edge_add_admin_panel(
			array(
				'page' => '_blog_page',
		...
		if(count($custom_sidebars) > 0) {
			oxides_edge_add_admin_field(array(
				...
				'parent' => $panel_blog_lists,
				'options' => oxides_edge_get_custom_sidebars()
			));
		}
		...
		$pagination_container = oxides_edge_add_admin_container(
			array(
		...
		oxides_edge_add_admin_field(
			array(
				'type' => 'text',
				'name' => 'checkered_number_of_chars',
				'default_value' => '',
				'label' => 'Checkered Type Number of Words in Excerpt',
				'parent' => $panel_blog_lists,
				'description' => 'Enter a number of words in excerpt (article summary)',
				'args' => array(
					'col_width' => 3
		...
		oxides_edge_add_admin_field(array(
			...
			'description'   => 'Enabling this option will show post categories on your page.',
			'parent'        => $panel_blog_lists,
			'default_value' => 'yes'
		));
		...
		oxides_edge_add_admin_field(array(
			...
			'type'          => 'yesno',
			'label'         => 'Show Likes',
			'description'   => 'Enabling this option will show post likes on your page. Only for Standard Blog template.',
			'parent'        => $panel_blog_lists,
			'default_value' => 'yes'
		));
		 ...
		 * Blog Single
		 */
		$panel_blog_single = oxides_edge_add_admin_panel(
			array(
				'page' => '_blog_page',
		...
		oxides_edge_add_admin_field(array(
			...
			'type'          => 'yesno',
			'label'         => 'Show Tags',
			'description'   => 'Enabling this option will show post tags on your page.',
			'parent'        => $panel_blog_single,
			'default_value' => 'yes'
		));
		...
		oxides_edge_add_admin_field(array(
			...
			'description'   => 'Enabling this option will show related posts on your page.',
			'parent'        => $panel_blog_single,
			'default_value' => 'yes'
		));
		...
		$blog_single_navigation_container = oxides_edge_add_admin_container(
			array(
		...
		$blog_single_author_info_container = oxides_edge_add_admin_container(
			array(
	...
	add_action( 'oxides_edge_options_map', 'oxides_edge_blog_options_map', 14 );
}