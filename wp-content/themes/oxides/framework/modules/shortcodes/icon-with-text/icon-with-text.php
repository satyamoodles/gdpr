<?php
namespace EdgeOxidesfModules\Shortcodes\IconWithText;

use EdgeOxidesfModules\Shortcodes\Lib\ShortcodeInterface;

/**
 * Class IconWithText
 * @package EdgeOxidesfModules\Shortcodes\IconWithText
 */
class IconWithText implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Edge Icon With Text', 'oxides'),
            'base'                      => $this->base,
            ...
            'params'                    => array_merge(
                ...
                array(
                    ...
                    array(
                        'type'       => 'dropdown',
                        'heading'    => 'Icon Vertical Position',
                    ...
                    array(
                        ...
                        'param_name'  => 'enable_text_separator',
                        'value'       => array(
                            'No'  => 'no',
                            'Yes' => 'yes'
                        ),
                        'group'      => 'Text Settings',
                        'description' => 'This option will enable separator between icon and text',
                        'dependency' => array('element' => 'icon_position', 'value' => array('left')),
                        'save_always' => true,
                        'admin_label' => true
                    )
    ...
    public function render($atts, $content = null) {
        ...
        return oxides_edge_get_shortcode_module_template_part('templates/iwt', 'icon-with-text', $params['icon_position'], $params);
    }
    ...
    private function getHolderClasses($params) {
        ...
        if($params['enable_text_separator'] == 'yes') {
            $classes[] = 'edgtf-iwt-with-text-separator';
        }

        if(!empty($params['icon_vertical_position'])) {
            $classes[] = 'edgtf-iwt-vertical-'.$params['icon_vertical_position'];
        }
    ...
    private function getContentStyles($params) {
        ...
        if($params['icon_position'] == 'left' && !empty($params['text_left_padding'])) {
            $styles[] = 'padding-left: '.oxides_edge_filter_px($params['text_left_padding']).'px';
        }
