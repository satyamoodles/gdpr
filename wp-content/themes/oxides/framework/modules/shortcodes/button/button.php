<?php
namespace EdgeOxidesfModules\Shortcodes\Button;
 ...
 * @package EdgeOxidesfModules\Shortcodes\Button
 */
class Button implements ShortcodeInterface {
    ...
    public function vcMap() {
        vc_map(array(
            'name'                      => esc_html__('Edge Button', 'oxides'),
            'base'                      => $this->base,
            'category'                  => 'by EDGE',
            ...
            'params'                    => array_merge(
                array(
                    array(
                        ...
                        'value'       => array(
                            ...
                            'Medium'          => 'medium',
                            'Large'           => 'large',
                            'Huge Full Width' => 'huge-full-width'
                        ),
                        'admin_label' => true
                    ),
                    array(
                ...
                oxides_edge_icon_collections()->getVCParamsArray(array(), '', true),
                array(
                    array(
                        'type'        => 'colorpicker',
                        'heading'     => 'Color',
                    ...
                    array(
                        ...
                        'value'       => oxides_edge_get_font_weight_array(true),
                        'admin_label' => true,
                        'group'       => 'Design Options',
                        'save_always' => true
                    ),
    ...
    public function render($atts, $content = null) {
        ...
        return oxides_edge_get_shortcode_module_template_part('templates/'.$params['html_type'], 'button', $params['hover_animation'], $params);
    }
    ...
    private function getButtonStyles($params) {
        ...
        if(!empty($params['font_size'])) {
            $styles[] = 'font-size: '.oxides_edge_filter_px($params['font_size']).'px';
        }
