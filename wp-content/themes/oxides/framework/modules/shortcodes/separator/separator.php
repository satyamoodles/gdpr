<?php
namespace EdgeOxidesfModules\Separator;
...
class Separator implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(
			array(
				'name' => esc_html__('Edge Separator', 'oxides'),
				'base' => $this->base,
				'category' => 'by EDGE',
	...
	public function render($atts, $content = null) {
		...
		$html = oxides_edge_get_shortcode_module_template_part('templates/separator-template', 'separator', '', $params);
	...
	private function getSeparatorStyle($params) {
		...
		if ($params['width'] !== '') {
			if(oxides_edge_string_ends_with($params['width'], '%') || oxides_edge_string_ends_with($params['width'], 'px')) {
		...
		if ($params['top_margin'] !== '') {
			if(oxides_edge_string_ends_with($params['top_margin'], '%') || oxides_edge_string_ends_with($params['top_margin'], 'px')) {
		...
		if ($params['bottom_margin'] !== '') {
			if(oxides_edge_string_ends_with($params['bottom_margin'], '%') || oxides_edge_string_ends_with($params['bottom_margin'], 'px')) {
