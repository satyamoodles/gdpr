<?php
namespace EdgeOxidesfModules\Dropcaps;
...
class Dropcaps implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = oxides_edge_get_shortcode_module_template_part('templates/dropcaps-template', 'dropcaps', '', $params);
	...
	private function getDropcapsStyle($params) {
        ...
        if ($params['border_color'] !== '') {
            $dropcaps_style[] = 'border: 2px solid '.$params['border_color'];
        }
