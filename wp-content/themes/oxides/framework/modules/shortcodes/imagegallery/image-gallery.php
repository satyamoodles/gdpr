<?php
namespace EdgeOxidesfModules\Shortcodes\ImageGallery;
...
class ImageGallery implements ShortcodeInterface{
	...
	public function vcMap() {
		...
		vc_map(array(
			'name'                      => esc_html__('Edge Image Gallery', 'oxides'),
			'base'                      => $this->getBase(),
			'category'                  => 'by EDGE',
	...
	public function render($atts, $content = null) {
		...
		$params['gallery_slider_classes'] = ($params['pagination'] == 'yes') ? 'edgtf-pagination-enabled' : '';
		...
		$html = oxides_edge_get_shortcode_module_template_part('templates/' . $template, 'imagegallery', '', $params);
	...
	private function getSliderData($params) {
		...
		$slider_data['data-column'] = ($params['column_number'] !== '') ? $params['column_number'] : '';
