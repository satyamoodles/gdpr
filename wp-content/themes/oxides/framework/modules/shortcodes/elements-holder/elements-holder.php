<?php
namespace EdgeOxidesfModules\ElementsHolder;
...
class ElementsHolder implements ShortcodeInterface{
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__('Elements Holder', 'oxides'),
			'base' => $this->base,
	...
	public function render($atts, $content = null) {
		...
		$html .= '<div ' . oxides_edge_get_class_attribute($elements_holder_class) . ' ' . oxides_edge_get_inline_attr($elements_holder_style, 'style'). '>';
