<?php
namespace EdgeOxidesfModules\ElementsHolderItem;
...
class ElementsHolderItem implements ShortcodeInterface{
	...
	public function vcMap() {
		if(function_exists('vc_map')){
			vc_map( 
				array(
					'name' => esc_html__('Elements Holder Item', 'oxides'),
					'base' => $this->base,
	...
	public function render($atts, $content = null) {
		...
		$params['elements_holder_item_data'] = $this->getElementsHolderItemData($params);
		...
		$html = oxides_edge_get_shortcode_module_template_part('templates/elements-holder-item-template', 'elements-holder', '', $params);
    ...
    /**
     * Return Elements Holder Item data
     *
     * @param $params
     * @return array
     */

    private function getElementsHolderItemData($params)
    {
        $data = array();
