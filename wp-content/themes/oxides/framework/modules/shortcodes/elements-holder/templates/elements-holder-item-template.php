<div class="edgtf-elements-holder-item <?php echo esc_attr($elements_holder_item_class); ?>" <?php echo oxides_edge_get_inline_style($elements_holder_item_style); ?> <?php echo oxides_edge_get_inline_attrs($elements_holder_item_data); ?>>
	<div class="edgtf-elements-holder-item-inner">
		<div class="edgtf-elements-holder-item-content <?php echo esc_attr($elements_holder_item_content_class); ?>" <?php echo oxides_edge_get_inline_style($elements_holder_item_content_style); ?>>
