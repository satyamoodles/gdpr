...
if ( ! function_exists('oxides_edge_search_options_map') ) {

	function oxides_edge_search_options_map() {
		...
		$search_panel = oxides_edge_add_admin_panel(
			array(
				'title' => 'Search',
				'name' => 'search',
				'page' => '_search_page'
		...
		oxides_edge_add_admin_field(
			array(
				...
				'options'		=> oxides_edge_icon_collections()->getIconCollectionsExclude(array('linea_icons', 'simple_line_icons', 'dripicons'))
			)
		);

		$search_height_container = oxides_edge_add_admin_container(
			array(
				'parent'			=> $search_panel,
		...
		$search_animation_container = oxides_edge_add_admin_container(
			array(
				'parent'			=> $search_panel,
		...
		oxides_edge_add_admin_section_title(
			array(
				'parent' 	=> $search_panel,
		...
		oxides_edge_add_admin_field(
			array(
				'parent'		=> $search_panel,
				'type'			=> 'text',
				'name'			=> 'header_search_icon_line_height',
				'default_value'	=> '',
				'label'			=> 'Icon Line Height',
				'description'	=> 'Set line height for icon',
				'args'			=> array(
					'col_width' => 3,
					'suffix'	=> 'px'
				)
		...
		$search_icon_color_group = oxides_edge_add_admin_group(
			array(
				'parent'	=> $search_panel,
				'title'		=> 'Icon Colors',
		...
		$search_icon_color_row = oxides_edge_add_admin_row(
			array(
		...
		$search_icon_color_row2 = oxides_edge_add_admin_row(
			array(
				'parent'	=> $search_icon_color_group,
		...
		$search_icon_background_group = oxides_edge_add_admin_group(
			array(
				'parent'	=> $search_panel,
				'title'		=> 'Icon Background and Border Style',
				'description'	=> 'Define background and border style for icon',
				'name'		=> 'search_icon_background_group'
			)
		);

		$search_icon_background_row = oxides_edge_add_admin_row(
			array(
		...
		$enable_search_icon_text_container = oxides_edge_add_admin_container(
			array(
				'parent'			=> $search_panel,
		...
		$enable_search_icon_text_group = oxides_edge_add_admin_group(
			array(
		...
		$enable_search_icon_text_row = oxides_edge_add_admin_row(
			array(
		...
		$enable_search_icon_text_row2 = oxides_edge_add_admin_row(
			array(
				'parent'	=> $enable_search_icon_text_group,
		...
		$enable_search_icon_text_row3 = oxides_edge_add_admin_row(
			array(
				'parent'	=> $enable_search_icon_text_group,
		...
		$search_icon_spacing_group = oxides_edge_add_admin_group(
			array(
				'parent'	=> $search_panel,
				'title'		=> 'Icon Spacing',
		...
		$search_icon_spacing_row = oxides_edge_add_admin_row(
			array(
		...
		$search_input_text_group = oxides_edge_add_admin_group(
			array(
				'parent'	=> $search_panel,
		...
		$search_input_text_row = oxides_edge_add_admin_row(
			array(
		...
		$search_input_text_row2 = oxides_edge_add_admin_row(
			array(
				'parent'	=> $search_input_text_group,
		...
		$search_label_text_group = oxides_edge_add_admin_group(
			array(
				'parent'	=> $search_panel,
		...
		$search_label_text_row = oxides_edge_add_admin_row(
			array(
		...
		$search_label_text_row2 = oxides_edge_add_admin_row(
			array(
				'parent'	=> $search_label_text_group,
		...
		$search_icon_group = oxides_edge_add_admin_group(
			array(
				'parent'	=> $search_panel,
				'title'		=> 'Search Icon',
		...
		$search_icon_row = oxides_edge_add_admin_row(
			array(
		...
		$search_close_icon_group = oxides_edge_add_admin_group(
			array(
				'parent'	=> $search_panel,
				'title'		=> 'Search Close',
		...
		$search_close_icon_row = oxides_edge_add_admin_row(
			array(
		...
		$search_bottom_border_group = oxides_edge_add_admin_group(
			array(
				'parent'	=> $search_panel,
		...
		$search_bottom_border_row = oxides_edge_add_admin_row(
			array(
	...
	add_action('oxides_edge_options_map', 'oxides_edge_search_options_map', 7);
