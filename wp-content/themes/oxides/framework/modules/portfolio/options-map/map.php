...
if ( ! function_exists('oxides_edge_portfolio_options_map') ) {

	function oxides_edge_portfolio_options_map() {
		...
		$container_navigate_category = oxides_edge_add_admin_container(array(
	...
	add_action( 'oxides_edge_options_map', 'oxides_edge_portfolio_options_map', 15 );
