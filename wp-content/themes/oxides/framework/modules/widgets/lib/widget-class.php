 ...
 *
 * Class EdgeOxidesWidget
 */
abstract class EdgeOxidesWidget extends WP_Widget {
    /**
    ...
    public function form($instance) {
        if(is_array($this->params) && count($this->params)) {
            ...
            <p><?php esc_html_e('There are no options for this widget.', 'oxides'); ?></p>
        <?php }
    }
...
$oxides_edgeFramework = EdgeOxidesFramework::get_instance();
$edgtSkinManager = new EdgeOxidesSkinManager();
$oxides_edgeFramework->setSkin($edgtSkinManager->getSkin());
