<?php do_action('oxides_edge_before_mobile_header'); ?>

<header class="edgtf-mobile-header">
    <div class="edgtf-mobile-header-inner">
        <?php do_action( 'oxides_edge_after_mobile_header_html_open' ) ?>
                    ...
                    <?php if($show_logo) : ?>
                        <div class="edgtf-position-center">
                            <div class="edgtf-position-center-inner">
                                <?php oxides_edge_get_mobile_logo(); ?>
                            </div>
                        </div>
                    <?php endif; ?>
        ...
        <?php oxides_edge_get_mobile_nav(); ?>
    </div>
</header> <!-- close .edgtf-mobile-header -->

<?php do_action('oxides_edge_after_mobile_header'); ?>