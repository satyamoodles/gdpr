...
if ( ! function_exists('oxides_edge_mobile_header_options_map') ) {

	function oxides_edge_mobile_header_options_map() {
		...
		$panel_mobile_header = oxides_edge_add_admin_panel(array(
			'title' => 'Mobile header',
		...
		oxides_edge_add_admin_field(array(
			'name'        => 'mobile_header_separator_color',
			'type'        => 'color',
			'label'       => 'Mobile Header Bottom Separator Color',
			'description' => 'Choose color for mobile header separator',
			'parent'      => $panel_mobile_header
		));
		...
		oxides_edge_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => oxides_edge_get_text_transform_array(true)
		));
		...
		oxides_edge_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => oxides_edge_get_font_style_array(true)
		));
		...
		oxides_edge_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => oxides_edge_get_font_weight_array(true)
		));
		...
		oxides_edge_add_admin_field(array(
			...
			'parent'      => $panel_mobile_header,
			'options'     => oxides_edge_icon_collections()->getIconCollectionsExclude(array('linea_icons', 'simple_line_icons'))
		));
	...
	add_action( 'oxides_edge_options_map', 'oxides_edge_mobile_header_options_map', 5 );
