...
if( ! class_exists('oxides_edge_sidebar') ){
	
	class oxides_edge_sidebar{
		...
		function __construct(){
			...
			$this->title = esc_html__('Custom Widget Area','oxides');
		...
		function load_assets(){
			...
			wp_enqueue_script('oxides_edge_sidebar' , EDGE_ROOT . '/framework/admin/assets/js/edgtf-sidebar.js');
			wp_enqueue_style( 'oxides_edge_sidebar' , EDGE_ROOT . '/framework/admin/assets/css/edgtf-sidebar.css');
		}
		...
		function template_add_widget_field(){
			...
			echo "\n    <span class='input_wrap'><input type='text' value='' placeholder = '".esc_html__('Enter Name of the new Widget Area', 'oxides')."' name='edgt-add-widget' /></span>";
			echo "\n    <input class='button' type='submit' value='".esc_html__('Add Widget Area', 'oxides')."' />";
			echo "\n    ".$nonce;
			echo "\n  </form>";
			echo "\n</script>\n";
		}
		...
		function register_custom_sidebars(){
			...
			$args = apply_filters('oxides_edge_custom_widget_args', $args);
