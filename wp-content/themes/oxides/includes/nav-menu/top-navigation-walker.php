 ...
 */
if (!class_exists('EdgefOxidesTopNavigationWalker')) {
	class EdgefOxidesTopNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($oxides_edge_options['enable_wide_manu_background'] == "yes" ){
			...
			if($item->hide == ""){
				...
				$angle_icon = '';
				if($depth == 1) {
					$angle_icon = '<i class="edgtf_menu_arrow arrow_carrot-right"></i>';
				}
				...
				if($args->has_children && $depth == 0) {
					$item_output .= '<span class="edgtf_menu_arrow arrow_carrot-down"></span>';
				}
