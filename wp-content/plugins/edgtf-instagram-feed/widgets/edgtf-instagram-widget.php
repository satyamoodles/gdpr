...
class EdgefOxidesInstagramWidget extends WP_Widget {
	...
	public function __construct() {
		parent::__construct(
			...
			array( 'description' => esc_html__( 'Display instagram images', 'oxides' ) )
		);
	...
	public function widget($args, $instance) {
		...
		$instagram_api = EdgeOxidesInstagramApi::getInstance();
				...
				foreach ($images_array as $image) { ?>
					<li>
						<a href="<?php echo esc_url($instagram_api->getHelper()->getImageLink($image)); ?>" target="_blank">
							<?php echo oxides_edge_kses_img($instagram_api->getHelper()->getImageHTML($image, $image_size)); ?>
						</a>
					</li>
				<?php } ?>
			</ul>
...
function oxides_edge_instagram_widget_load(){
	register_widget('EdgefOxidesInstagramWidget');
}

add_action('widgets_init', 'oxides_edge_instagram_widget_load');