...
class PortfolioRegister implements PostTypeInterface {
    ...
    private function registerPostType() {
        global $oxides_edgeFramework, $oxides_edge_options;
        ...
        if(edgt_core_theme_installed()) {
            ...
            if(isset($oxides_edge_options['portfolio_single_slug'])) {
                if($oxides_edge_options['portfolio_single_slug'] != ""){
                    $slug = $oxides_edge_options['portfolio_single_slug'];
                }
            }
        }
