...
class EdgefOxidesTwitterWidget extends WP_Widget {
    private $params;
    ...
    public function __construct() {
        parent::__construct(
            ...
            'Edge Twitter Widget',
            array( 'description' => esc_html__( 'Display tweets', 'oxides' ) )
        );
    ...
    public function widget($args, $instance) {
        ...
        if($twitter_api->hasUserConnected()) {
            ...
            esc_html_e('It seams that you haven\'t connected with your Twitter account', 'oxides');
        }
...
function oxides_edge_twitter_widget_load(){
    register_widget('EdgefOxidesTwitterWidget');
}

add_action('widgets_init', 'oxides_edge_twitter_widget_load');